/* 
 * Taurus light-weight expressjs Grunt automation
 * 
...
module.exports = function (grunt) {
    ...
    grunt.registerTask('build', 'Publish taurus npm package.', function() {
        ...
        _ref('./Gruntfile.js','./build',true);
        _ref('./LICENSE','./build',true);
        _ref('./README.md','./build',true);
        _ref('./index.js','./build',true);
        _ref('./package.json','./build',true);
